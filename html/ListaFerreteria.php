<!--  ../html/ListaFerreteria.php  -->

<?php 

	require '../html/MenuFerreteria.php' ;
...
?>
		...
		<div class="d-flex justify-content-center">
			...
			<p class="card-header text-center h4"><?= $_REQUEST['producto'] ?></p>
					...
					<div class="d-flex justify-content-end">
						<form action="" method="post" onsubmit="return ValidarCambiarPrecio();">
							<div class="form-row">
								...
								<div class="col-auto">
									<input type="submit" value="Aceptar" class="btn btn-outline-primary mb-2">
								</div>
							</div>
						</form>
					</div>
						...
						<table class="table table-sm table-bordered table-hover" style="width: 45rem;">
							...
							<tbody>
								<tr> 
									...
									<td> <a href="../controllers/editar-producto.php?id=<?= $t['id_producto'] ?>-producto=<?= $_REQUEST['producto'] ?>"><span class="icon-edit"></span></a> </td>
								</tr>	
							</tbody>
							<?php endforeach ?>
						</table>
